...
FROM `ft-bi-team.BI_Layer_Integration.known_user_daily_status`
...
SELECT FORMAT_DATE('%Y-%m', '2022-01-01') as month, p5.dec_21_jan_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-02-01') as month, p5.jan_22_feb_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-03-01') as month, p5.feb_22_mar_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-04-01') as month, p5.mar_22_apr_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-05-01') as month, p5.apr_22_may_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-06-01') as month, p5.may_22_jun_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-07-01') as month, p5.jun_22_jul_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-08-01') as month, p5.jul_22_aug_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-09-01') as month, p5.aug_22_sep_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-10-01') as month, p5.sep_22_oct_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-11-01') as month, p5.oct_22_nov_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2022-12-01') as month, p5.nov_22_dec_22 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-01-01') as month, p5.dec_22_jan_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-02-01') as month, p5.jan_23_feb_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-03-01') as month, p5.feb_23_mar_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-04-01') as month, p5.mar_23_apr_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-05-01') as month, p5.apr_23_may_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-06-01') as month, p5.may_23_jun_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-07-01') as month, p5.jun_23_jul_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-08-01') as month, p5.jul_23_aug_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-09-01') as month, p5.aug_23_sep_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-10-01') as month, p5.sep_23_oct_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-11-01') as month, p5.oct_23_nov_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2023-12-01') as month, p5.nov_23_dec_23 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-01-01') as month, p5.dec_23_jan_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-02-01') as month, p5.jan_24_feb_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-03-01') as month, p5.feb_24_mar_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-04-01') as month, p5.mar_24_apr_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-05-01') as month, p5.apr_24_may_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-06-01') as month, p5.may_24_jun_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-07-01') as month, p5.jun_24_jul_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-08-01') as month, p5.jul_24_aug_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-09-01') as month, p5.aug_24_sep_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-10-01') as month, p5.sep_24_oct_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-11-01') as month, p5.oct_24_nov_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2024-12-01') as month, p5.nov_24_dec_24 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-01-01') as month, p5.dec_24_jan_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-02-01') as month, p5.jan_25_feb_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-03-01') as month, p5.feb_25_mar_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-04-01') as month, p5.mar_25_apr_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-05-01') as month, p5.apr_25_may_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-06-01') as month, p5.may_25_jun_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-07-01') as month, p5.jun_25_jul_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-08-01') as month, p5.jul_25_aug_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-09-01') as month, p5.aug_25_sep_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-10-01') as month, p5.sep_25_oct_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-11-01') as month, p5.oct_25_nov_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2025-12-01') as month, p5.nov_25_dec_25 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-01-01') as month, p5.dec_25_jan_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-02-01') as month, p5.jan_26_feb_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-03-01') as month, p5.feb_26_mar_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-04-01') as month, p5.mar_26_apr_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-05-01') as month, p5.apr_26_may_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-06-01') as month, p5.may_26_jun_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-07-01') as month, p5.jun_26_jul_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-08-01') as month, p5.jul_26_aug_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-09-01') as month, p5.aug_26_sep_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-10-01') as month, p5.sep_26_oct_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-11-01') as month, p5.oct_26_nov_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2026-12-01') as month, p5.nov_26_dec_26 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-01-01') as month, p5.dec_26_jan_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-02-01') as month, p5.jan_27_feb_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-03-01') as month, p5.feb_27_mar_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-04-01') as month, p5.mar_27_apr_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-05-01') as month, p5.apr_27_may_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-06-01') as month, p5.may_27_jun_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-07-01') as month, p5.jun_27_jul_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-08-01') as month, p5.jul_27_aug_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-09-01') as month, p5.aug_27_sep_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-10-01') as month, p5.sep_27_oct_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-11-01') as month, p5.oct_27_nov_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2027-12-01') as month, p5.nov_27_dec_27 as movement, count(distinct user_guid) as users from p5 group by 1,2 
/* Commented out SQL code
union all
SELECT FORMAT_DATE('%Y-%m', '2028-01-01') as month, p5.dec_27_jan_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-02-01') as month, p5.jan_28_feb_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-03-01') as month, p5.feb_28_mar_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-04-01') as month, p5.mar_28_apr_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-05-01') as month, p5.apr_28_may_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-06-01') as month, p5.may_28_jun_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-07-01') as month, p5.jun_28_jul_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-08-01') as month, p5.jul_28_aug_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-09-01') as month, p5.aug_28_sep_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-10-01') as month, p5.sep_28_oct_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-11-01') as month, p5.oct_28_nov_28 as movement, count(distinct user_guid) as users from p5 group by 1,2 union all
SELECT FORMAT_DATE('%Y-%m', '2028-12-01') as month, p5.nov_28_dec_28 as movement, count(distinct user_guid) as users from p5 group by 1,2
*/
