SELECT 
DATE_TRUNC(DATE(run_date) - 1, MONTH) date
...
FROM `ft-data-science.historic.b2c_acquisition_initial_12m_ltv`
WHERE DATE_TRUNC(run_date, MONTH) BETWEEN '2022-01-01' AND '2028-12-01'
...
region, discount
from
`ft-data-science.latest.b2c_arrangement_ltv`
